...
(:objects 
	...
	car0 car1 car2 car3 car4 car5 car6 car7 car8
)
(:init
...
(place x50) (place x51) (place x52) (place x53) (place x54) (place x55)
				 		 		 (available x04) (available x05)
				 		 		 (available x14) (available x15)
(available x20) 		 		 		 		 (available x25)
(available x30) 		 		 (available x33) (available x34) (available x35)
(available x40) 		 		 (available x43) (available x44) (available x45)
(available x50) 		 		 (available x53) (available x54) (available x55)
(car car0)
(car car1)
(car car2)
(car car3)
