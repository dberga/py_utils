...
(place x50) (place x51) (place x52) (place x53) (place x54) (place x55)
		(available x01) (available x02) 		 (available x04) (available x05)
		(available x11) (available x12) 		 (available x14) (available x15)
(available x20) (available x21) (available x22) 		 (available x24) (available x25)
(available x30) (available x31) (available x32) 		 (available x34) (available x35)
(available x40) (available x41) (available x42) 		 (available x44) (available x45)
(available x50) (available x51) (available x52) 		 (available x54) (available x55)
(car car0)
(car car1)
(car car2)
(car car3)
